    ...
    return (
        <div className='flex flex-col w-full justify-around gap-2 py-2'>
            <div className='flex flex-row justify-between'>
                ...
                <Link to={`/employee/request`} className='flex flex-row items-center gap-2 text-gray-medium font-semibold hover:underline text-sm'>
                    <p>Đến</p>
                    <FaArrowRight />
                </Link>
            </div>
            ...
            <div className='grid grid-cols-2 ml-5 justify-between text-[1.1rem] pr-5 gap-2'>
                <div className='font-medium text-gray-600'>Đã gửi: </div>
...
export default EmpRequestDetails